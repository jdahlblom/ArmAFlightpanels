...
{
    public class KnobBindingArmaPZ70
    {
        /*
        ...
        internal void ImportSettings(string settings)
        {
            ...
            if (settings.StartsWith("MultiPanelKnobArmA{"))
            {
                //MultiPanelKnobArmA{1KNOB_ENGINE_LEFT}\o/OSKeyPress{[FiftyMilliSec,RCONTROL + RSHIFT + VK_R][FiftyMilliSec,RCONTROL + RSHIFT + VK_W]}\o/\\?\hid#vid_06a3&pid_0d67#9&231fd360&0&0000#{4d1e55b2-f16f-11cf-88cb-001111000030}
                var parameters = settings.Split(new[] { SeparatorChars }, StringSplitOptions.RemoveEmptyEntries);

                //MultiPanelKnobArmA{1KNOB_ENGINE_LEFT}
                var param0 = parameters[0].Replace("MultiPanelKnobArmA{", "").Replace("}", "");
                //1KNOB_ENGINE_LEFT
        ...
        public string ExportSettings()
        {
            ...
            return "MultiPanelKnobArmA{" + onStr + Enum.GetName(typeof(MultiPanelPZ70Knobs), MultiPanelPZ70Knob) + "}" + SeparatorChars + _osKeyPress.ExportString();
        }
