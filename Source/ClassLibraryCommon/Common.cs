...
namespace ClassLibraryCommon
{
    ...
    public static class Common
    {
        ...
        public static bool IsKeyEmulationProfile(ProfileMode profileMode)
        {
            return profileMode == ProfileMode.KEYEMULATOR || profileMode == ProfileMode.KEYEMULATOR_ARMA;
    }
        ...
        public static void ShowErrorMessageBox(uint location, Exception ex, string message = null)
        {
            ...
            {
                MessageBox.Show(location + " " + message + "\n" + ex.Message, "Details logged to error log.");
            }
            else
            {
